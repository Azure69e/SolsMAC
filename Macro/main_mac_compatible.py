...
if sys.platform == "win32":
    WORK_DIR = os.path.join(os.environ["LOCALAPPDATA"], "SolsScope")
    LIB_DIR = os.path.join(WORK_DIR, "lib")
    LEGACY_DIR = os.path.join(os.environ["LOCALAPPDATA"], "Baz's Macro")
else:
    WORK_DIR = os.path.expanduser("~/Library/Application Support/SolsScope")
    LIB_DIR = os.path.join(WORK_DIR, "lib")
    LEGACY_DIR = os.path.expanduser("~/Library/Application Support/Baz's Macro")
